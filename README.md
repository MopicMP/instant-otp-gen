...
> Instant generate totp/hotp one-time passwords

[![PyPI version](https://badge.fury.io/py/instant-otp-gen.svg)](https://pypi.org/project/instant-otp-gen/)
...
```bash
pip install instant-otp-gen
```

## Quick Start

```python
from instant_otp_gen import gen
...
from instant_otp_gen import batch
